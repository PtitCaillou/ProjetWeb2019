...
<?php $__env->startSection('li'); ?>
  <header>
    <div class="menu-top">
      ...
      <a href="<?php echo e(('productadd')); ?>" class="btn btn-lg active" role="button" aria-pressed="true" style="position:relative; background-color: rgb(238, 193, 94); left:160%;"> Ajouter un produit</a>      <?php endif; ?>
