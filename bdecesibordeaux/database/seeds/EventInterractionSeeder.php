...
class EventInterractionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('EventInterraction')->insert(['user_id' => '1', 'event_id' => '2', 'interractiontype_id' => '5', 'content' => '']);
        DB::table('EventInterraction')->insert(['user_id' => '2', 'event_id' => '1', 'interractiontype_id' => '5', 'content' => '']);
        DB::table('EventInterraction')->insert(['user_id' => '3', 'event_id' => '1', 'interractiontype_id' => '5', 'content' => '']);
    }
}
