...
Route::get('autocompleteShop', 'shopController@autocomplete')->name('autocomplete');
Route::get('autocompleteActivity', 'activityController@autocomplete')->name('autocomplete');
